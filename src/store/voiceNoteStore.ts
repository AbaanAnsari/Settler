...
export const useVoiceNoteStore = create<VoiceNoteState>((set) => {
  ...
  return {
    ...
    deleteNote: deleteVoiceNoteImpl,

    deleteVoiceNote: deleteVoiceNoteImpl,
  };
});
